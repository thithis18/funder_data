...
**data sets** are in this readme file you are reading, available on
GitHub: <https://github.com/Between-the-Fjords/funder_data>

The **data** from the project is stored and available on OSF:
<https://osf.io/tx9r2/>

All R code for the analyses from the Norwegian project is on GitHub:
<https://github.com/Between-the-Fjords/funder_data>

General information about the project are available on the project
webpage: <https://betweenthefjords.w.uib.no/three-d/>
...
plant species was estimated visually. At 4 points in the grid, average
vegetation height and moss layer depth was measured using a ruler. For
each turf, date, originSite, originBlockID, originPlotID, weather,
scribe and recorder and remarks were noted down. A picture was taken
from each plot.
...
Reflectance (greenness) was measured several times during the season in
