...
To create the metadata, a file includes all the sites, blocks and treatments run the following code.
It will directly produce an excel file called: *Funder_2022_metadata.csv*.
...
Find the file *R/data_dic/data_dic.R*.
Add code to import the dataset, e.g. read_csv and give it a name.
Then run the function make_data_dic() on your dataset.
